          ...
          <div class="aa-header-top-area"> 
            ...
            <div class="aa-header-top-left"> 
              ...
              <div class="aa-currency">
                <div class="dropdown"> <a class="btn dropdown-toggle" href="#" type="button" id="dropdownMenu1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true"> <i class="fa fa-inr"></i>INR <span class="caret"></span> </a>
                  <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
              ...
              <div class="cellphone hidden-xs">
                <p><span class="fa fa-phone"></span>91 8123456734</p>
              </div>
              <!-- / cellphone --> 
            </div>
            <!-- / header top left -->
      ...
      <div class="col-md-12">
        <div class="aa-testimonial-area">
          <ul class="aa-testimonial-slider">
            <!-- single slide -->
            <li>
              <div class="aa-testimonial-single">  <span class="fa fa-quote-left aa-testimonial-quote"></span>
                <p></p>
                <div class="aa-testimonial-info">
                  <p>“Whoever said that money can’t buy happiness simply didn’t know where to go shopping.”</p>
                  <span>— Bo Derekr</span> <a href="#"></a> </div>
              </div>
            </li>
            <!-- single slide -->
            <li>
              <div class="aa-testimonial-single"> <span class="fa fa-quote-left aa-testimonial-quote"></span>
                ...
                <div class="aa-testimonial-info">
                  ...
                  <span>— Marilyn Monroe</span> <a href="#"></a> </div>
              </div>
            </li>
            <!-- single slide -->
            <li>
              <div class="aa-testimonial-single">  <span class="fa fa-quote-left aa-testimonial-quote"></span>
                ...
                <div class="aa-testimonial-info">
                  ...
                  <span>— Tammy Faye Bakker</span> <a href="#"></a> </div>
              </div>
            </li>
          </ul>
        </div>
              ...
              <div class="col-md-3 col-sm-6">
                <div class="aa-footer-widget">
                  <div class="aa-footer-widget">
                    <h3>Contact Us</h3>
                    <address>
                    <p> 142/sector-4 Joseph Road bangluru, Karnataka,India</p>
                    <p><span class="fa fa-phone"></span>+91 8123456734</p>
                    <p><span class="fa fa-envelope"></span>Eshop@gmail.com</p>
                    </address>
      ...
      <div class="row">
        <div class="col-md-12">
          <div class="aa-footer-bottom-area">
            <p>Designed by Bhavya Srivastava</p>
